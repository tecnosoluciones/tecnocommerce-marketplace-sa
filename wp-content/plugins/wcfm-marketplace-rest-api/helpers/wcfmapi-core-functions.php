...
function wcfm_api_change_onesignal_tokens ( $one_signal_tokens ) {
  $one_signal_tokens['rest_api_key'] = "YmQwYWZhYTMtY2JmMy00YWI1LWIxNTgtYjA5OTdhMDAwMWY5";
...
function wcfm_api_change_onesignal_delivery_tokens ( $one_signal_tokens ) {
  $one_signal_tokens['rest_api_key'] = "ZDQ5YTA3MmYtNmQwMC00ZTk0LTg4NWUtMWRiYWZkYTZjZjQz";
  return $one_signal_tokens;
}
