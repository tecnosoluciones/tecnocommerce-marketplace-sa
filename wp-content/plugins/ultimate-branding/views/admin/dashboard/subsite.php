...
<?php if ( $message['show'] && is_super_admin() ) { ?>
	...
	<?php
		printf(
			esc_html__( '%1$s, only modules you have allowed subsite access to will be able here. You can add or remove modules from the %2$sPermissions Settings%3$s.', 'ub' ),
