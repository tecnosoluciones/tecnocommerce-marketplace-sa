<div class="sui-box-body sui-message sui-message-lg">
	<img
		src="<?php echo esc_html( branda_url( 'assets/images/branda/circle-confused@1x.png' ) ); ?>"
		srcset="<?php echo esc_html( branda_url( 'assets/images/branda/circle-confused@2x.png' ) ); ?> 2x"
		class="sui-image"
		aria-hidden="true"
	/>
