		...
		<div class="sui-box">
				...
				<div class="sui-box-body">
					...
					<div class="sui-form-field">
						...
						<?php
							printf(
								esc_html__( 'With the SMTP log feature you will be able to gather detailed information about your emails with %1$sSMTP log%2$s feature. You can track recipients\' email histories and export the log history.', 'ub' ),
