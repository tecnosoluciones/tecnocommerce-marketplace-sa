<div class="sui-builder-field" data-nonce="<?php echo esc_attr( $nonce ); ?>" data-id="<?php echo esc_attr( $id ); ?>">
	...
	<div class="sui-button-icon sui-button-red sui-hover-show  branda-admin-help-content-item-delete">
	...
	<div class="sui-button-icon  branda-admin-help-content-item-edit">
