...
class SCD_WCFM_Marketplace_Report_Sales_By_Date extends WC_Admin_Report {
	...
	public function query_report_data() {
		...
		if (!function_exists('scd_wcfmmp_get_commission_meta_sum')) {
			# code...
			include WP_PLUGIN_DIR.'/scd_wcfm_marketplace/includes/scd-wcfm-functions.php';
		}
	...
	public function get_main_chart( $show_legend = 1 ) {
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				var sales_data = <?php echo json_encode($chart_data); ?>;
				var show_legend    = <?php echo json_encode($show_legend) ; ?>;
