...
class WCFM_Appointments_Calendar {
	...
	public function single_appointment_card( $appointment, $event_start, $event_end, $list = '' ) {
		...
		if ( 'by_time' === $list ) {
			$duration_minutes = ( function_exists( 'wc_appointment_duration_in_minutes' ) ) ? wc_appointment_duration_in_minutes( $event_start, $event_end, 'minute', false ) : $appointment->get_duration( false );
