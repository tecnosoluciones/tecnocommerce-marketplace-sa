	...
	<div id="wcfm_products_manage_form_wc_fooevents_expander" class="wcfm-content">
	  ...
	  <div id="woocommerce_events_data" class="panel woocommerce_options_panel">
				...
				<p class="form-field">
				  <span class="wcfm_title"><strong><?php _e('Is this product an event?', 'woocommerce-events'); ?></strong>
						...
						printf(
							...
							__('This option enables event and ticketing functionality.', 'woocommerce-events')
						);
						?>
					</span>
					...
					<div class="options_group">
						<p class="form-field">
							 <span class="wcfm_title"><strong><?php _e('Number of days:', 'fooevents-multiday-events'); ?></strong>
								...
								printf(
									'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
									__('Select the number of days for multi-day events. This setting is used by the Event Check-ins apps to manage daily check-ins.', 'fooevents-multiday-events')
								);
								?>
							 </span>
        ...
        <div class="options_group" id="WooCommerceEventsDateContainer">
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Start Date:', 'woocommerce-events'); ?></strong>
					...
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__("The date that the event is scheduled to take place. This is used as a label on your website and it's also used by the FooEvents Calendar to display the event.", 'woocommerce-events')
					);
					?>
				</span>
			...
			<div class="options_group" id="WooCommerceEventsEndDateContainer">
				<p class="form-field">
					<span class="wcfm_title"><strong><?php _e('End Date:', 'fooevents-multiday-events'); ?></strong>
						...
						printf(
							'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
							__("The date that the event is scheduled to end. This is used as a label on your website and it's also used by the FooEvents Calendar to display a multi-day event.", 'fooevents-multiday-events')
						);
						?>
					</span>
        ...
        <?php if ( WCFMu_Dependencies::wcfm_wc_fooevents_calendar() && !empty($globalFooEventsEventbriteToken) ) { ?>
			<div class="options_group">
				<p class="form-field">
					<span class="wcfm_title checkbox_title"><strong><?php _e('Add event to EventBrite', 'fooevents-calendar'); ?></strong>
					<?php 
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__('Checking this option will submit the event to Eventbrite.', 'woocommerce-events')
					);
					?>
					</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Venue:', 'woocommerce-events'); ?></strong>
					...
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__('The venue where the event will be hosted.', 'woocommerce-events')
					);
					?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('GPS Coordinates:', 'woocommerce-events'); ?></strong>
					...
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__('GPS coordinates for the venue.', 'woocommerce-events')
					);
					?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Google Maps coordinates:', 'woocommerce-events'); ?></strong>
					<?php 
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__('GPS coordinates that are used to calculate the pin position for Google Maps on the event page. A valid Google Maps API key must first be saved in FooEvents settings.', 'woocommerce-events')
					);
					?>
				</span>
				...
				<?php if( !wcfm_is_vendor() && empty($globalWooCommerceEventsGoogleMapsAPIKey)) :?>
					<p class="description">
					<?php _e('Google Maps API key not set.','woocommerce-events'); ?> <a href="admin.php?page=wc-settings&tab=settings_woocommerce_events"><?php _e('Please check the Event Integration settings.', 'woocommerce-events'); ?></a>
					</p>
				<?php endif; ?>
			</p>
        </div>
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Directions:', 'woocommerce-events'); ?></strong>
					<?php 
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__('Directions to the venue.', 'woocommerce-events')
					);
					?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Phone number::', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__("Event organizer's contact number.", 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Email address:', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
        ...
        <div class="options_group">
			...
			<p class="form-field">
				<?php
				$WCFM->wcfm_fields->wcfm_generate_form_field( array( "WooCommerceEventsTicketHeaderImage" => array( 'label' => __( 'Ticket header image:', 'woocommerce-events' ), 'wcfm_uploader_by_url' => true, 'type' => 'upload', 'label_class' => 'wcfm_title', 'value' => $WooCommerceEventsTicketHeaderImage, 'hints' => __('Full URL that links to the image that will be used as the ticket header (JPG or PNG format).', 'woocommerce-events') ) ) );
				?>
			</p>
        </div>
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Ticket email subject:', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__("The subject line used in ticket emails. Use {OrderNumber} to display the proper order number.", 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			...
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Ticket accent:', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('This color is used for the ticket border or background.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			...
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Ticket button:', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('Color of the ticket button.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			...
			<p class="form-field">
				...
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('Color of the ticket button text.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <?php if ( WCFMu_Dependencies::wcfm_wc_fooevents_calendar() ) { ?>
			<div class="options_group">
				...
				<p class="form-field">
					<span class="wcfm_title"><strong><?php _e('Calendar background color:', 'fooevents-calendar'); ?></strong>
					<?php 
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__('Color of the calendar background for the event. Also changes the background color of the date icon in the FooEvents Check-ins app.', 'fooevents-calendar')
					);
					?>
					</span>
			...
			<div class="options_group">
				...
				<p class="form-field">
					<span class="wcfm_title"><strong><?php _e('Calendar text color:', 'fooevents-calendar'); ?></strong>
					<?php 
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__('Color of the calendar text for the event. Also changes the font color of the date icon in the FooEvents Check-ins app.', 'fooevents-calendar')
					);
					?>
					</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title checkbox_title"><strong><?php _e('Display purchaser or attendee details on ticket?', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__("Display the purchaser/attendee's name and details on the ticket.", 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title checkbox_title"><strong><?php _e('Display "Add to calendar" option on ticket?', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__("Display an 'Add to calendar' button on the ticket which will generate an ICS file containing the event details when clicked.", 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				...
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('Display the time and date of the event on the ticket.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				...
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('Display a barcode on the ticket which is used for check-ins.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				...
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('Display the ticket price on the ticket.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title checkbox_title"><strong><?php _e('Capture attendee full name and email address? ', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('This will add attendee capture fields on the checkout screen.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title checkbox_title"><strong><?php _e('Display custom attendee details on ticket?', 'woocommerce-events'); ?></strong>
					...
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__('This will display custom attendee fields on the ticket.', 'woocommerce-events')
					);
					?>
					</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title checkbox_title"><strong><?php _e('Email ticket to attendee rather than purchaser?', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('This will email the ticket to the attendee instead of the ticket purchaser.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title checkbox_title"><strong><?php _e('Capture attendee phone number?', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('This will add a telephone number field to the attendee capture fields on the checkout screen.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				<span class="wcfm_title checkbox_title"><strong><?php _e('Capture attendee company name?', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('This will add a company field to the attendee capture fields on the checkout screen.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				...
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('This will add a designation field to the attendee capture fields on the checkout screen.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <div class="options_group">
			<p class="form-field">
				...
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__('This will email the event tickets to the attendee or purchaser once the order has been completed.', 'woocommerce-events')
				);
				?>
				</span>
        ...
        <?php if ( WCFMu_Dependencies::wcfm_wc_fooevents_seating() ) : ?>
			<div class="options_group">
				<p class="form-field">
					<span class="wcfm_title checkbox_title"><strong><?php _e('Display seating chart on checkout page?', 'woocommerce-events'); ?></strong>
					<?php 
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__("This will display a 'View seating chart' link on the checkout page. Before enabling this option, please ensure that you have setup a seating chart on the Event Seating tab.", 'woocommerce-events')
					);
					?>
					</span>
        ...
        <div class="options_group">
          	<p><h2><?php _e('Event Terminology', 'woocommerce-events'); ?></h2><div class="wcfm-clearfix"></div></p>
			<p class="form-field">
				<span class="wcfm_title"><strong><?php _e('Attendee:', 'woocommerce-events'); ?></strong>
				<?php 
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__("Change 'Attendee' to your own custom text for this event.", 'woocommerce-events')
				);
				?>
				</span>
			...
			<p class="form-field">
				...
				printf(
					'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
					__("Change 'Book ticket' to your own custom text for this event.", 'woocommerce-events')
				);
				?>
				</span>
			...
			<?php if( WCFMu_Dependencies::wcfm_wc_fooevents_multiday() ) { ?>
				<p class="form-field">
					...
					printf(
						'<span class="img_tip wcfmfa fa-question" data-tip="%s"></span>',
						__("Change 'Day' to your own custom text for this event.", 'woocommerce-events')
					);
					?>
					</span>
