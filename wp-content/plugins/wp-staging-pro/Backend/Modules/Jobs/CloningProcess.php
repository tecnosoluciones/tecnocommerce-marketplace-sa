...
abstract class CloningProcess extends JobExecutable
{
    ...
    protected function initializeDbObjects()
    {
        ...
        if ($this->isExternal()) {
            ...
            //Some values of stagingDb are changed later. Passing it by reference would lead to productionDb being changed as well
            $this->stagingDb = clone WPStaging::getInstance()->get("wpdb");
        }
    }
