...
use WPStaging\Service\CloningProcess\CloningDto;
use WPStaging\Service\CloningProcess\Database\DatabaseCloningService;
...
class Database extends CloningProcess
{
    ...
    {
        if ($this->getStagingPrefix() == $this->stagingDb->prefix) {
