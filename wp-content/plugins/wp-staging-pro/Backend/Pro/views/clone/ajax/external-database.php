...
if( empty( $options->current ) || null === $options->current ) {
    ...
    <table cellspacing="0" id="wpstg-external-db">
        ...
        <tr>
            <th><?php _e("Database Prefix", "wp-staging")?></th><td><input readonly type="text" name="wpstg_db_prefix" id="wpstg_db_prefix" value="" placeholder="<?php echo $db->prefix; ?>" autocapitalize="off">
            </td></tr>
        <tr>
            <th></th>
