...
None, at this moment! PayPal stopped new applications for adaptive payment long ago. Also, there is no news about the new marketplace API on the website. So, we are stuck.

= WHAT WCFM Marketplace - DIRECT PAYPAL PAY DO? =

WCFM Direct PayPal Pay enables direct payment from customer to vendor. But here split payment is not involved. The amount goes directly to the vendor account. The vendor then has to return the admin commission, manually. Both, admin and vendor can track their commission using [Withdrawal and Ledger Book screen](https://wclovers.com/knowledgebase/wcfm-marketplace-reverse-withdrawal/).


= RESTRICTIONS =

👉 One order will contain products from only one vendor 
👉 The full amount will go into Vendor’s PayPal account, doesn't involve split payment
👉 Vendor’s PayPal account should be a business account

Of course, this solution is less flexible than Stripe split payment. But, if direct payment is required in your locality and Stripe is not available, then you can go for this as an alternate to run your marketplace. Happy Selling!
